...
class LiveDataManager {
    ...
    private let addressBookLockQueue = DispatchQueue(label: "LiveDataManager.AddressBook.lockQueue")
    ...
    private let detailDisplayDataLockQueue = DispatchQueue(label: "LiveDataManager.AddressBook.lockQueue")
