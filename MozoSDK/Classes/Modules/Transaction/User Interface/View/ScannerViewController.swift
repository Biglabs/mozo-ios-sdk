...
//        let height = scanRect.height/640
        // MARK: limit capture area: metadataOutput.rectOfInterest = CGRect(x: x, y: y, width: width, height: height)
    ...
    public override func viewDidLayoutSubviews() {
        ...
        if !isViewCreated {
            ...
            let titleLabel = UILabel(frame: CGRect(x: titleMargin, y: 100, width: view.bounds.width - (titleMargin * 2), height: 30))
